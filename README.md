...
## Project Description
“Elemental Quest” is a game application in the strategy genre. It is turn-based duel game where battles use a simplified rock-paper-scissors mechanic, but the game introduces elements which are fire, water, and grass instead. Every element has their own strength and weaknesses against each other. This emphasizes players to plan their moves carefully which creating an engaging and interactive experience that challenges both logic and strategy.  
